...
<div>
    ...
    <li><a href="complaintlist">添加投诉</a></li>
    <li><a href="javaScript:void(0)">添加投诉</a></li>
    </ul>
    </div>
  ...
  <form class="form-search">
	...
	<div class="div">
  	...
  	<div class="divs" style="padding-left: 60px;">
  		<a class="enter">确认投诉</a>
  	</div>
  </form>
  </div>
  <script type="text/javascript" src="${pageContext.request.contextPath}/assets/js/addcomp.js"></script>
</body>
</html>